...
SHASUM_MACOS_ARM=$(curl -fsSL "https://github.com/garfieldius/t3ll/releases/download/v${VERSION}/t3ll-${VERSION}.arm64_big_sur.bottle.tar.gz.sha256.txt")
...
cat t3ll.rb.tmpl \
  ...
  | sed "s,__SHASUM_MACOS_ARM64__,${SHASUM_MACOS_ARM}," \
